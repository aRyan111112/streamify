import { getMyFriendReqs, acceptFriendRequest } from "../lib/api.js";
...
const NotificationsPage = () => {
  ...
  const incomingReqs = incomingRequests?.friendRequests || [];
  const acceptedreqs = incomingRequests?.acceptedRequests || [];
